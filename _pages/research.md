...
<details>
<summary>The Legacies of Performance Legitimacy: Citizen Evaluations After Opposition Takeover in Hybrid Regimes. </summary>
<p>
Abstract: Why do opposition governments often struggle to gain public approval after winning local elections in hybrid regimes? I argue that authoritarian incumbents leave behind enduring evaluative legacies through performance legitimacy. By associating effective governance with the ruling party rather than state institutions, they reshape how citizens assess government performance. Consequently, opposition governments face asymmetric accountability and are more likely to be blamed for routine governance problems. I test this argument using an original dataset of over 15 million citizen complaints submitted to Istanbul's municipal government between 2013 and 2023. Exploiting the opposition's 2019 electoral victory, I employ event-study and difference-in-differences designs to examine changes in citizen evaluations following local democratic turnover. Complaint volumes increase sharply after the opposition takes office, particularly in districts with strong incumbent support, despite no evidence of declining service provision. The findings reveal how authoritarian legacies continue to shape accountability after electoral turnover, and raise important questions about the durability of opposition gains in such regimes. 
</p>
</details>


<details>
<summary> Challenging Kinship Politics: Education and Candidate Entry in Local Elections With <a href="https://www.tugbabozcaga.com">Tugba Bozcaga (King's College)</a>, <a href="https://aytugsasmaz.com">Aytug Sasmaz (Bryn Mawr College)</a> <em>(Under Review)<em></summary>
<p>
